...
namespace UNICAH.Modelo
{
    ...
    public partial class UnicahEntities : DbContext
    {
        public UnicahEntities()
            : base("name=UnicahEntities")
        {
        }
        ...
        public virtual DbSet<ClaseDia> ClaseDia { get; set; }
        public virtual DbSet<ClasePeriodo> ClasePeriodo { get; set; }
